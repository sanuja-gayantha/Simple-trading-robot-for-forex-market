                ...
                if crates is not None:
                    for row_values in crates:
                        ...
                        #take positive values 
                            ...
                            if self.ctype == "GBPNZD" or self.ctype == "EURNZD" or self.ctype == "AUDNZD" :
...
def main_loop(time_framel, sedatel):
    ...
    #currency pair list
    currency_pair_list = ["AUDNZD", "NZDUSD", "NZDJPY", "NZDCHF", "GBPNZD", "EURNZD", "NZDCAD"]
    while i < 7:
    ...
    nzd_fresult = OrderedDict(sorted(result.items()))
    #print(b)
