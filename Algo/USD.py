                ...
                if crates is not None:
                    for row_values in crates:
                        ...
                        if timepn == 0:
                            ...
                            if self.ctype == "EURUSD" or self.ctype == "AUDUSD" or self.ctype == "NZDUSD" or self.ctype ==  "GBPUSD":
...
def main_loop(time_framel, sedatel):
    ...
    #currency pair list
    currency_pair_list = ["AUDUSD", "NZDUSD", "USDJPY", "USDCHF", "GBPUSD", "EURUSD", "USDCAD"]
    while i < 7:
    ...
    usd_fresult = OrderedDict(sorted(result.items()))
    #print(b)
