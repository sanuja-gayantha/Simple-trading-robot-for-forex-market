                ...
                if crates is not None:
                    for row_values in crates:
                        ...
                        #take positive values 
                            ...
                            if self.ctype == "GBPAUD" or self.ctype == "EURAUD" :
...
def main_loop(time_framel, sedatel):
    ...
    #currency pair list
    currency_pair_list = ["AUDUSD", "AUDNZD", "AUDJPY", "AUDCHF", "GBPAUD", "EURAUD", "AUDCAD"]
    while i < 7:
    ...
    aud_fresult = OrderedDict(sorted(result.items()))
    #print(aud_fresult)
