...
def main_loop(time_framel, sedatel):
    ...
    #currency pair list
    currency_pair_list = ["GBPAUD", "GBPNZD", "GBPJPY", "GBPCHF", "GBPUSD", "EURGBP", "GBPCAD"]
    while i < 7:
    ...
    gbp_fresult = OrderedDict(sorted(result.items()))
    #print(b)
