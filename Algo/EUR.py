                ...
                if crates is not None:
                    for row_values in crates:
                        ...
                        #take positive values 
                            ...
                            self.pnvalues[timepn] = round((((row_values[4] - zero_value) * self.boolvalue)  / timepn), 6)
                            #print(timepn , aud_positive)
...
#This function calculate 7 EUR chart average tan(-1) alpa value of each hour  
def main_loop(time_framel, sedatel):
    ...
    #currency pair list
    currency_pair_list = ["EURAUD", "EURNZD", "EURJPY", "EURCHF", "EURGBP", "EURUSD", "EURCAD"]
    while i < 7:
    ...
    eur_fresult = OrderedDict(sorted(result.items()))
    #print(b)
