                ...
                if crates is not None:
                    for row_values in crates:
                        ...
                        if timepn == 0:
                            ...
                            if self.ctype == "USDCAD" or  self.ctype == "NZDCAD" or self.ctype == "GBPCAD" or self.ctype == "EURCAD" or self.ctype ==  "AUDCAD":
...
def main_loop(time_framel, sedatel):
    ...
    #currency pair list
    currency_pair_list = ["USDCAD", "NZDCAD", "CADJPY", "CADCHF", "GBPCAD", "EURCAD", "AUDCAD"]
    while i < 7:
    ...
    cad_fresult = OrderedDict(sorted(result.items()))
    #print(b)
